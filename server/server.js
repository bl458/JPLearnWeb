...
app.get("/video_vocab", (req, res) => {
  ...
  const VIDEO_VOCAB_QUERY = `INSERT INTO jquiz_video_vocab(google_id, video_id, kanji, hiragana, english) VALUES('${googleId}', '${vidId}' , '${kanji}', '${hiragana}', '${english}')`;
...
app.get("/review", (req, res) => {
  ...
  const REVIEW_QUERY = `INSERT INTO jquiz_review(google_id, deck, kanji, hiragana, english) VALUES('${googleId}', '${deck}' , '${kanji}', '${hiragana}', '${english}')`;
...
app.get("/progress", (req, res) => {
  ...
  const PROGRESS_QUERY = `INSERT INTO jquiz_progress(google_id, deck, kanji) VALUES('${googleId}', '${deck}' , '${kanji}')`;
...
app.get("/view_progress", (req, res) => {
  ...
  const VIEW_PROGRESS_QUERY = `SELECT * FROM jquiz_progress WHERE google_id=${googleId} and deck=${deck}`;
...
app.get("/load_deck", (req, res) => {
  ...
  const LOAD_DECK_QUERY = `SELECT * FROM jquiz_${deck}`;
