...
var Kanji = /** @class */ (function (_super) {
    ...
    Kanji.prototype.render = function () {
        ...
        return (React.createElement("span", { className: componentClass, style: { padding: spacing.kanji } },
            React.createElement("sup", { style: { left: spacing.furigana, opacity: opacity }, className: furiganaClassNames }, furigana),
            React.createElement("span", { className: kanjiClassNames }, kanji)));
    };
    return Kanji;
}(React.Component));
...
var Furigana = /** @class */ (function (_super) {
    ...
    Furigana.prototype.buildRender = function (cutChildren, matchedKanji) {
        var _this = this;
        return (React.createElement(React.Fragment, null, cutChildren.map(function (text, i) {
            var item = matchedKanji[i];
            if (typeof item === 'undefined') {
                return React.createElement("span", { key: text + i }, text);
            }
            var spacing = getSpacing(item.kanji, item.furigana, _this.props.spacingUnit);
            if (text === "") {
                return (React.createElement(Kanji, { opacity: _this.props.opacity, key: item.kanji + text + i, spacing: spacing, kanji: item.kanji, furigana: item.furigana, styles: styles }));
            }
            else {
                return (React.createElement("span", { key: item.kanji + text + i },
                    React.createElement("span", null, text),
                    React.createElement(Kanji, { opacity: _this.props.opacity, spacing: spacing, kanji: item.kanji, furigana: item.furigana, styles: styles })));
            }
        })));
    };
    Furigana.prototype.render = function () {
        return (React.createElement("span", { id: this.props.id, className: styles.wrapper }, this.buildFuri()));
    };
    return Furigana;
}(React.Component));

exports.Furigana = Furigana;
